export const COMPANY = {
  ...
  email: "hello@myskybuy.in",
  website: "https://myskybuy.in",
};
...
export const policies: Record<string, PolicyContent> = {
  "return-policy": {
    title: "Return Policy",
    intro: `At ${COMPANY.brand}, we want you to be confident in every purchase — whether you are buying a backpack for daily commute, a handbag for everyday styling, travel luggage, or a wallet and accessory. This Return Policy explains when and how you may return eligible products purchased from our online store.`,
    sections: [
      {
      ...
      },
      {
        ...
        body: "Returns are accepted for unused, unwashed, undamaged products sold as bags, backpacks, handbags, travel luggage, slings, wallets and related accessories, when all of the following conditions are met:",
        bullets: [
  ...
  "refund-policy": {
    title: "Refund Policy",
    intro: `This Refund Policy describes how ${COMPANY.brand} processes refunds for cancelled orders, approved returns, failed deliveries, and payment-related issues on products such as bags, backpacks, travel luggage, handbags, and accessories purchased through our website.`,
    sections: [
      {
  ...
  "cancellation-policy": {
    ...
    intro: `We understand plans can change. This Cancellation Policy explains how customers of ${COMPANY.brand} can cancel orders for bags, backpacks, handbags, travel luggage and accessories, and what happens after an order is packed or shipped.`,
    sections: [
      {
  ...
  "shipping-delivery-policy": {
    ...
    intro: `${COMPANY.brand} ships carefully packed bags, backpacks, handbags, travel luggage and accessories across India. This policy explains dispatch timelines, delivery estimates, shipping charges, and what to do if a shipment is delayed or damaged.`,
    sections: [
      {
      ...
      {
        heading: "5. Packaging",
        body: "Products are packed to protect shape and finish — especially structured handbags, hard luggage, and backpacks with frames. Please inspect the outer carton on delivery and note visible damage with the courier before accepting, wherever possible.",
      },
      {
  ...
  "privacy-policy": {
    ...
    intro: `This Privacy Policy explains how ${COMPANY.name} (“we”, “us”, “${COMPANY.brand}”) collects, uses, stores and protects your personal information when you browse our website, create an account, place an order for bags and travel essentials, or contact our support team. We are committed to handling your data responsibly in line with applicable Indian laws including the Information Technology Act, 2000 and related rules.`,
    sections: [
      {
        heading: "1. Information we collect",
        body: "Depending on how you use MySkyBuy, we may collect:",
        bullets: [
      ...
      },
      {
        ...
        bullets: [
          "Process, fulfil and deliver orders of bags, backpacks, luggage and accessories.",
  ...
  "terms-of-use": {
    title: "Terms of Use",
    intro: `Welcome to ${COMPANY.brand}. These Terms of Use (“Terms”) govern your access to and use of our website, mobile browsing experience, and purchase of products including bags, backpacks, handbags, travel luggage, wallets and accessories. By using the site, you agree to these Terms. If you do not agree, please do not use the website.`,
    sections: [
      {
